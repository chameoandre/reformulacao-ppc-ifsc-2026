...
Títulos Disponíveis no Acervo Sophia & 138 (67.6\%) & Obras com presença física confirmada no câmpus \\ \hline
Títulos Ausentes no Acervo Sophia & 66 (32.4\%) & Demanda prioritária para aquisição \\ \hline
Variações de Edição / Ano & 25 & Obras presentes com edição divergente da citada \\ \hline
\textbf{DEMANDA DE COMPRAS: Básica ($<$ 3 ex.)} & \textbf{+100 ex.} & \textbf{Exemplares para meta de 3 cópias na básica} \\ \hline
\textbf{DEMANDA DE COMPRAS: Complementar ($<$ 1 ex.)} & \textbf{+46 ex.} & \textbf{Exemplares para meta de 1 cópia na complementar} \\ \hline
\textbf{DEMANDA TOTAL DE COMPRAS} & \textbf{\textcolor{ifscgreen}{+146 EX.}} & \textbf{Total consolidado para conformidade 100\%} \\ \hline
\end{tabularx}
\end{table}

\newpage
\section*{3. Lista Prioritária de Aquisições: Bibliografia BÁSICA (+100 exemplares)}
...
4º & FERRAMENTAS DE GESTÃO AMBIENTAL & Ferramentas de gestão ambiental: competitividade e sustentabilidade & PIMENTA, Handson Cláudio Dias; GOUVINHAS, Reidson Pereira & \textbf{+1 ex.} \\ \hline
...
1º & PLANEJAMENTO E GESTÃO DO TURISMO RESPONSÁVEL & São Paulo: Roca, 2005 & DESENVOLVIMENTO sustentável do turismo: uma compilação de boas práticas & \textbf{+1 ex.} \\ \hline
...
\newpage
\section*{4. Lista de Aquisições: Bibliografia COMPLEMENTAR (+46 exemplares)}
