...
Prof. André Luiz Silva de Moraes (Articulador da Reformulação PPC)

\subsection{Equipe elaboradora do projeto de curso:}
Comissão de Reformulação do PPC Técnico em Administração (Portaria Câmpus Garopaba 2026/XXX)
...
\paragraph{Formação Geral (Base Nacional Comum Curricular):} 2.100 horas-relógio (Mínimo regulamentar).
\paragraph{Formação Técnica Profissional (Eixo Gestão e Negócios):} 1.000 horas-relógio (CNCT).
\paragraph{Núcleo Politécnico Comum (Projetos e Oficinas de Integração):} 120 horas-relógio.
\paragraph{Carga Horária Total Mínima do Curso:} 3.100 horas-relógio.
...
Formação Geral (BNCC + Diversificada) & 2.100 h & 67,7\% \\ \hline
Formação Técnica Profissional (Administração) & 1.000 h & 32,3\% \\ \hline
Núcleo Politécnico Comum (Projetos / Oficinas) & 120 h & (Integrado) \\ \hline
\textbf{Carga Horária Total do Curso} & \textbf{3.100 h} & \textbf{100,0\%} \\ \hline
\end{tabular}
