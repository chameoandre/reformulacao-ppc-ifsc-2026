...
\revisao{\textbf{DICIONÁRIO Oxford escolar}: para estudantes brasileiros de inglês: português-inglês, inglês-português. 3. ed. atual. Oxford: Oxford University, 2018.} \newline
\revisao{LATHAM-KOENIG, Christina. \textbf{English File}: Intermediate Student's Book. Oxford: Oxford University Press, 2018.} \newline
...
\revisao{BAGNO, Marcos. \textbf{Nada na língua é por acaso}: por uma pedagogia da variação linguística. 2. ed. São Paulo: Parábola Editorial, 2008. 238 p. ISBN 9788588456624.} \newline
BAGNO, Marcos. \textbf{Preconceito linguístico}. 56. ed. rev. e ampl. São Paulo: Parábola Editorial, 2015. 350 p. ISBN 9788579340987.
} \\ \hline
\end{xltabular}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\revisao{DANTE, Luiz Roberto. \textbf{Projeto Múltiplo}: matemática: ensino médio: 1° ano. São Paulo: Ática, 2014. 240 p.} \newline
\revisao{\textbf{Livro didático fornecido pelo Fundo Nacional de Desenvolvimento da Educação (FNDE)}.}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
MENDONÇA, Francisco; DANNI-OLIVEIRA, Inês Moresco. \textbf{Climatologia}: noções básicas e climas do Brasil. São Paulo: Oficina de Textos, 2007. 208 p. \newline
ROSS, Jurandyr L. Sanches (org.). \textbf{Geografia do Brasil}. 6. ed. São Paulo: EDUSP, 2011. 600 p. \newline
VESENTINI, José William. \textbf{Geografia}: o mundo em transição. 2. ed. São Paulo: Ática, 2014. 416 p.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
ALMEIDA, Lúcia Marina Alves de; RIGOLIN, Tércio Barbosa. \textbf{Fronteiras da Geografia}. São Paulo: Ática, 2017. 384 p. \newline
MOREIRA, Ruy. \textbf{O pensamento geográfico brasileiro}. 2. ed. São Paulo: Contexto, 2014. 224 p. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
ARAÚJO, Luiz Cesar G. de. \textbf{Organização, sistemas e métodos}. São Paulo: Atlas, 2010. \newline
BERNARDI, Luiz Antonio. \textbf{Manual de empreendedorismo e gestão}: fundamentos, estratégias e dinâmicas. 2. ed. São Paulo: Atlas, 2012. \newline
...
\revisao{LATHAM-KOENIG, Christina. \textbf{English File}: Intermediate Student's Book. Oxford: Oxford University Press, 2018.} \newline
\textbf{Livro didático fornecido pelo Fundo Nacional de Desenvolvimento da Educação (FNDE)}. \newline
\revisao{WHITLAM, John. \textbf{Collins dicionário prático}: inglês/português, português/inglês. 2. ed. São Paulo: Disal [distribuidora]: HarperCollins Publisher, 2018.}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{FRANCO, C. P. \textbf{English vibes for Brazilian learners}: volume único. 1. ed. São Paulo: FTD, 2020. \newline
MURPHY, Raymond. \textbf{Essential Grammar in Use}. 4th ed. Cambridge: Cambridge University Press, 2015. \newline \revisao{WHARTON, Sue. \textbf{500 tips for tesol}: (teaching english to speakers of other languages). London: Kogan Page, 1999.} } \\ \hline
...
LUZ, Antônio Máximo Ribeiro da; ALVARENGA, Beatriz Gonçalves de. \textbf{Curso de física, volume 2}. 6. ed. rev. ampl. São Paulo: Scipione, 2006.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
BARRETO FILHO, Benigno; SILVA, Cláudio Xavier da. \textbf{360º física}: aula por aula: volume único. 3. ed. São Paulo: FTD, 2015. \newline
KNIGHT, Randall D. \textbf{Física}: uma abordagem estratégica: volume 2: termodinâmica e óptica. 2. ed. Porto Alegre: Bookman, 2009. \newline
...
\revisao{GIOVANNI, José Ruy \textit{et al.} \textbf{360º matemática fundamental}: uma nova abordagem: volume único. 2. ed. São Paulo: FTD, 2015.} \newline
\revisao{\textbf{Livro didático fornecido pelo Fundo Nacional de Desenvolvimento da Educação (FNDE)}.}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
LIMA, E. L.; CARVALHO, Paulo Cesar P. \textbf{A Matemática do ensino médio}: volume único. 7. ed. Rio de Janeiro: SBM, 2016. \newline
LIMA, Elon Lages \textit{et al.} \textbf{A matemática do ensino médio}: volume 1. 10. ed. Rio de Janeiro: SBM, 2016. 240 p. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\revisao{ATKINS, Peter William; JONES, Loretta. \textbf{Princípios de química}: questionando a vida moderna e o meio ambiente. 5. ed. Porto Alegre: Bookman, 2012.} \newline
CHANG, Raymond. \textbf{Química geral}: conceitos essenciais. 4. ed. Porto Alegre: AMGH, 2010. \newline
PERUZZO, Francisco Miragaia; CANTO, Eduardo Leite do. \textbf{Química na abordagem do cotidiano}: volume único. 3. ed. São Paulo: Moderna, 2007.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
COSTA, Maria Cristina. \textbf{Sociologia}: introdução à ciência da sociedade. 5. ed. São Paulo: Editora Moderna, 2016. \newline
HELENA, Bomeny \textit{et al.} \textbf{Tempos Modernos, tempos de sociologia}. 4. ed. São Paulo: Ed. do Brasil, 2016. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\revisao{BARBETTA, Pedro Alberto. \textbf{Estatística aplicada às ciências sociais}. Florianópolis: Edufsc, 2010.} \newline
\revisao{BRUNI, Adriano Leal; FAMÁ, Rubens. \textbf{Matemática financeira com HP 12C e Excel}. São Paulo: Atlas, 2008.} \newline
\revisao{BUENO, Fabrício. \textbf{Estaticópolis}: um jeito novo de aprender Estatística. São Paulo: Amazon, 2015.} \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
ARBACHE, F. S. \textit{et al.} \textbf{Gestão de logística, distribuição e trade marketing}. Rio de Janeiro: FGV, 2004. \newline
...
\revisao{MARTINS, Petrônio Garcia; LAUGENI, Fernando Piero. \textbf{Administração da produção}. São Paulo: Saraiva, 2006.} \newline
MOREIRA, Daniel Augusto. \textbf{Administração da produção e operações}. São Paulo: Cengage Learning, 2009. \newline
NOGUEIRA, José Francisco. \textbf{Gestão estratégica de serviços}: teoria e prática. São Paulo: Atlas, 2008.
} \\ \hline
\end{xltabular}
...
HEWITT, Paul G. \textbf{Física conceitual}. 12. ed. Porto Alegre: Bookman, 2015. \newline
\textbf{Livro didático fornecido pelo Fundo Nacional de Desenvolvimento da Educação (FNDE)}. \newline
LUZ, Antônio Máximo Ribeiro da; ALVARENGA, Beatriz Gonçalves de. \textbf{Curso de física, volume 3}. 6. ed. rev. ampl. São Paulo: Scipione, 2006.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
BARRETO FILHO, Benigno; SILVA, Cláudio Xavier da. \textbf{360º física}: aula por aula: volume único. 3. ed. São Paulo: FTD, 2015. \newline
KNIGHT, Randall D. \textbf{Física}: uma abordagem estratégica: volume 3: eletricidade e magnetismo. 2. ed. Porto Alegre: Bookman, 2009. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
LIMA, E. L.; CARVALHO, Paulo Cesar P. \textbf{A Matemática do ensino médio}. 7. ed. Rio de Janeiro: SBM, 2016. \newline
LIMA, Elon Lages \textit{et al.} \textbf{A matemática do ensino médio}: volume 1. 10. ed. Rio de Janeiro: SBM, 2016. 240 p. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\revisao{HAESBAERT, Rogério. \textbf{O mito da desterritorialização}: do "fim dos territórios" à multiterritorialidade. 13. ed. Rio de Janeiro: Bertrand Brasil, 2004.} \newline
...
\revisao{SANTOS, Milton. \textbf{A natureza do espaço}: técnica e tempo. Razão e emoção. 4. ed. São Paulo: EdUSP, 2002.}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
BHABHA, Homi. \textbf{O local da cultura}. Belo Horizonte: Editora UFMG, 1999. \newline
CAREGNATO, Célia Elizabete; BOMBASSARO, Luiz Carlos (org.). \textbf{Diversidade cultural}: viver diferenças e enfrentar desigualdades na educação. Erechim, RS: Novello \& Carbonelli, 2013. \newline
CERTEAU, Michel de. \textbf{A invenção do cotidiano}: artes de fazer. Petrópolis, RJ: Vozes, 2009. \newline
GALEANO, Eduardo. \textbf{As caras e as máscaras}. Porto Alegre: L\&PM Editores, 2004. \newline
...
\revisao{HOBSBAWM, Eric John. \textbf{Era dos extremos}: o breve século XX: 1914-1991. São Paulo: Companhia das Letras, 2005.} \newline
HOLLANDA, Heloísa Buarque de (org.). \textbf{Pensamento Feminista Hoje}: perspectivas decoloniais. Rio de Janeiro: Bazar do Tempo, 2020. \newline
MIGNOLO, Walter. \textbf{Histórias Globais/projetos Locais}. Belo Horizonte: Editora UFMG, 2003. \newline
RICKLEFS, Robert E. \textbf{A economia da natureza}. Rio de Janeiro: Guanabara Koogan, 2010. \newline
SANTOS, Boaventura de Sousa; MARTINS, Bruno Sena (org.). \textbf{O pluriverso dos direitos humanos}: a diversidade das lutas pela dignidade. Belo Horizonte: Autêntica, 2019. \newline
SOUZA, Laura Olivieri Carneiro de. \textbf{Quilombos}: identidade e história. Rio de Janeiro: Nova Fronteira, 2012. \newline
\revisao{WALSH, Catherine. \textbf{Pedagogías decoloniales}: prácticas insurgentes de resistir, (re)existir y (re)vivir. Tomo II. Quito: Abya-Yala, 2017.}
} \\ \hline
\end{xltabular}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
KEELLING, Ralph; BRANCO, Renato Henrique Ferreira. \textbf{Gestão de projetos}: uma abordagem global. Tradução de Cid Knipel Moreira. 4. ed. São Paulo: Saraiva, 2019. \newline
\revisao{LIMA, Elon Lages \textit{et al.} \textbf{A matemática do ensino médio}: volume 1. 10. ed. Rio de Janeiro: Sociedade Brasileira de Matemática, 2012.} \newline
