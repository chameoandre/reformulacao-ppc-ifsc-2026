...
3º Ano & Oficina de Integração II & Núcleo Politécnico & 160 h \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Aulas expositivas dialogadas e contextualizadas, buscando aproximação com o cotidiano dos estudantes. A apresentação dos conteúdos trabalhados ocorrerá por meio da audição, conversação, leitura e produção de textos e/ou apresentações com recursos multimídia. Projetos e atividades envolvendo gêneros textuais de natureza lúdica (como música e vídeo), informativa (como notícias e textos científicos), literárias (como poemas e obras) e/ou técnica e científica. Atividades que propiciem ao estudante a oportunidade de compartilhar conhecimento com os colegas. \newline\vspace{2pt}
\textbf{Avaliação:} Avaliação contínua e processual, acompanhando o desenvolvimento das quatro habilidades linguísticas (ouvir, falar, ler e escrever), por meio da participação em sala de aula, produções individuais e em equipe, exercícios práticos e apresentações.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
...
MURPHY, Raymond. \textbf{Essential Grammar in Use}. 4. ed. Cambridge: Cambridge University Press, 2015. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
Conceitos de Linguagem; Leitura, compreensão, análise e produção de textos de diferentes tipologias e gêneros; Aspectos gramaticais da Língua Portuguesa: fonética e fonologia; Introdução à Literatura: identificação do contexto e das características de movimentos literários (Trovadorismo ao Arcadismo); Introdução a obras literárias produzidas por autores negros e indígenas brasileiros; Introdução aos aspectos históricos do português brasileiro, bem como sua influência na formação da língua.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{BAGNO, Marcos. \textbf{Nada na língua é por acaso}: por uma pedagogia da variação linguística. 2. ed. São Paulo: Parábola Editorial, 2008. 238 p., il. (Educação linguística, 1). ISBN 9788588456624. \newline
...
BAGNO, Marcos. \textbf{Gramática, pra que te quero?}: os conhecimentos linguísticos nos livros didáticos de português. Curitiba: Aymará, 2010. 319 p., il. col. (Mundo das ideias). ISBN 9788578416201.} \\ \hline
\end{xltabular}
...
SADAVA, David \textit{et al.} \textbf{Vida}: a ciência da biologia: volume 1: célula e hereditariedade. 8. ed. Porto Alegre: Artmed, 2009. \newline
\textbf{Livro didático fornecido pelo Fundo Nacional de Desenvolvimento da Educação (FNDE)}.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{BRUCE, Alberts \textit{et al.} \textbf{Biologia molecular da célula}. 6. ed. Porto Alegre: Artmed, 2017. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\textbf{Parte I — Fundamentos:} Potenciação (definição, propriedades, expoentes fracionários); Radiciação (definição, propriedades, simplificação, racionalização, equações com radicais, gráficos e aplicações); Conjuntos numéricos (naturais, inteiros, racionais, irracionais e reais, operações e propriedades, conversão entre decimais e frações, dízimas periódicas e não periódicas); Equações do 1º grau; Equações do 2º grau; Sistemas lineares 2x2 (método da adição e substituição). \newline\vspace{2pt}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{DIAS, Reinaldo; ZAVAGLIA, Tércia; CASSAR, Maurício. \textbf{Introdução à administração}: da competitividade à sustentabilidade. 3. ed. rev. Campinas, SP: Alínea, 2013. \newline
MAXIMIANO, Antonio Cesar Amaru. \textbf{Introdução à administração}. 8. ed. rev. e ampl. São Paulo: Atlas, 2011.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{CHIAVENATO, Idalberto. \textbf{Administração nos novos tempos}. 2. ed. rev. e atual. Rio de Janeiro: Elsevier, 2010. \newline
LACOMBE, Francisco José Masset; HEILBORN, Gilberto Luiz José. \textbf{Administração}: princípios e tendências. 3. ed. São Paulo: Saraiva, 2015. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{COSTA, Maria Cristina. \textbf{Sociologia}: introdução à ciência da sociedade. 5. ed. São Paulo: Editora Moderna, 2016. \newline
OLIVEIRA, Luiz Fernandes de; COSTA, Ricardo Cesar Rocha da. \textbf{Sociologia para jovens do século XXI}. Rio de Janeiro: Imperial Novo Milênio, 2013. \newline
HELENA, Bomeny [\textit{\textit{et al.}}]. \textbf{Tempos Modernos, tempos de sociologia}. 4. ed. São Paulo: Ed. do Brasil, 2016.} \\ \hline
\end{xltabular}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Compreender os conceitos fundamentais de marketing e sua importância estratégica para as organizações contemporâneas.
    \item Analisar o ambiente de marketing (micro e macroambiente) e os fatores que influenciam o comportamento do consumidor.
    \item Identificar técnicas de pesquisa de mercado e segmentação de consumidores para seleção de mercados-alvo.
    \item Desenvolver o pensamento crítico sobre ética, responsabilidade social e sustentabilidade nas decisões de marketing.
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
...
Estratégia de marketing: mercado-alvo, segmentação de mercado e posicionamento da marca (\textit{STP}). \newline
\textbf{Temáticas Transversais Obrigatórias:} Ética e Direitos Humanos na publicidade e no marketing; Responsabilidade socioambiental e consumo consciente; Diversidade e inclusão social na representação de consumidores.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Componente curricular fundamentado em metodologias ativas, associando aulas expositivas dialogadas, análise de casos práticos de marcas reais, exercícios de segmentação de mercado e oficinas de pesquisa de campo/virtual. Utilização dos laboratórios de informática do câmpus para consulta a acervos e simuladores. Articula-se diretamente com Introdução à Administração, Organização e Processos e Gestão de Marketing II. \newline\vspace{2pt}
\textbf{Avaliação:} Processual e contínua. Instrumentos: estudos de caso em grupo, pesquisas de mercado simples, apresentações orais de planos de segmentação e avaliações escritas de sintonia teórica.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{KOTLER, Philip; ARMSTRONG, Gary. \textbf{Princípios de marketing}. 15. ed. São Paulo: Pearson Education do Brasil, 2015. 624 p. \newline
CHURCHILL JR., Gilbert A.; PETER, J. Paul. \textbf{Marketing}: criando valor para os clientes. 3. ed. São Paulo: Saraiva, 2012. 640 p. \newline
LAS CASAS, Alexandre Luzzi. \textbf{Administração de marketing}: conceitos, planejamento e aplicações à realidade brasileira. 2. ed. São Paulo: Atlas, 2019. 544 p.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{KOTLER, Philip; KARTAJAYA, Hermawan; SETIAWAN, Iwan. \textbf{Marketing 5.0}: tecnologia para a humanidade. Rio de Janeiro: Sextante, 2021. 224 p. \newline
HOOLEY, Graham; NICHOULLS, J. A. F. \textbf{Estratégia de marketing e posicionamento competitivo}. 4. ed. São Paulo: Pearson, 2011. 480 p. \newline
COBRA, Marcos. \textbf{Marketing básico}: conceitos, exercícios e casos. 5. ed. São Paulo: Atlas, 2010. 432 p.} \\ \hline
\end{xltabular}
...
CINTRA, M.; CUNHA, M. P. \textbf{Rotinas administrativas}. São Paulo: KCM, 2008. \newline
FARIAS, Cláudio V. S. (org.). \textbf{Técnico em administração}: gestão e negócios. Porto Alegre: Bookman, 2013.} \\ \hline
\end{xltabular}
...
MANZANO, André Luiz N. \textbf{G.; MANZANO, Maria Izabel N. G. Estudo dirigido de informática básica}. 7. ed. atual., rev. e ampl. São Paulo: Érica, 2007.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
JR., Edgard Bruno C. \textbf{Informática Aplicada às Áreas de Contabilidade, Administração e Economia}. 4. ed. Rio de Janeiro: Atlas, 2012. E-book. ISBN 9788522494651. \newline
...
SOUSA, Cruz e. \textbf{Broquéis, Faróis}. Jaraguá do Sul: Avenida, 2007. 219 p. (Grandes obras da língua portuguesa). ISBN 9788598610849. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{CEREJA, William Roberto; MAGALHÃES, Thereza Cochar. \textbf{Gramática}: texto, reflexão e uso. 3. ed. reform. São Paulo: Atual, 2008. 496 p. ISBN 9788535709988.} \\ \hline
\end{xltabular}
...
DANTE, L. R. \textbf{Matemática contexto e aplicações}. 4. ed. São Paulo: Ática, 2011.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Compreender e operacionalizar os quatro elementos do composto de marketing (Mix de Marketing / 4 Ps: Produto, Preço, Praça/Distribuição e Promoção/Comunicação).
    \item Planejar o ciclo de vida do produto e o desenvolvimento de novas ofertas com foco na proposta de valor.
    \item Entender as estratégias de precificação, canais de distribuição e comunicação integrada de marketing no ambiente físico e digital.
    \item Elaborar um plano de marketing operacional integrado para pequenos e médios empreendimentos.
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
O Composto de Marketing (\textit{Mix de Marketing} / 4 Ps): integração e aplicação estratégica. \newline
Decisões sobre Produtos e Serviços: conceito, classificação, ciclo de vida do produto, marcas, embalagens e desenvolvimento de novos produtos. \newline
Estratégias de Precificação: métodos de formação de preços, fatores que afetam o preço e estratégias de preço para novos produtos. \newline
Canais de Distribuição e Gestão de Praça: canais diretos e indiretos, logística de distribuição, trade marketing e e-commerce. \newline
Comunicação Integrada de Marketing (Promoção): propaganda, promoção de vendas, relações públicas, vendas pessoais, marketing direto e marketing digital. \newline
Elaboração e apresentação do Plano de Marketing Simplificado. \newline
\textbf{Temáticas Transversais Obrigatórias:} Ética e transparência na comunicação publicitária; Defesa do consumidor e Direitos Humanos; Práticas sustentáveis na embalagem, logística e ciclo de vida dos produtos.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Desenvolvida através de Aprendizagem Baseada em Projetos (PBL), estudos de caso contemporâneos, simulações de campanha e elaboração prática de um Plano de Marketing Simplificado para empresas locais ou startups simuladas. Utilização dos laboratórios de informática e da sala de inovação (LINEDS). Articula-se com Gestão de Marketing I, Empreendedorismo I e II, Gestão de Operações e Qualidade, e Oficina de Integração I. \newline\vspace{2pt}
\textbf{Avaliação:} Formativa e processual, fundamentada no acompanhamento da elaboração do Plano de Marketing em etapas, apresentações orais em formato \textit{pitch}, análises de campanhas publicitárias e autoavaliação.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{KOTLER, Philip; KELLER, Kevin Lane. \textbf{Administração de marketing}. 15. ed. São Paulo: Pearson Education do Brasil, 2018. 848 p. \newline
NICKELS, William G.; WOOD, Marian Burk. \textbf{Marketing}: relacionamento, qualidade, valor. Rio de Janeiro: LTC, 2014. 490 p. \newline
FERRELL, O. C.; HARTLINE, Michael D. \textbf{Estratégia de marketing}. 4. ed. São Paulo: Cengage Learning, 2011. 672 p.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{PINHO, J. B. \textbf{Comunicação em marketing}: princípios da comunicação mercadológica. 7. ed. Campinas: Papirus, 2008. 240 p. \newline
KOTLER, Philip; KARTAJAYA, Hermawan; SETIAWAN, Iwan. \textbf{Marketing 4.0}: do tradicional ao digital. Rio de Janeiro: Sextante, 2017. 208 p. \newline
DIAS, Sergio Roberto (org.). \textbf{Gestão de marketing}. 2. ed. São Paulo: Saraiva, 2014. 464 p.} \\ \hline
\end{xltabular}
...
DIAS, Marco Aurélio P. \textbf{Administração de materiais}: uma abordagem logística. 5. ed. São Paulo: Atlas, 2010. \newline
GIANESI, Irineu G. \textbf{N.; CORRÊA, Henrique Luiz. Administração estratégica de serviços}: operações para a satisfação do cliente. São Paulo: Atlas, 2013. \newline
PALADINI, Edson P. \textbf{Gestão estratégica da qualidade}: princípios, métodos e processos. 2. ed. São Paulo: Atlas, 2009.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
...
MARTINS, Petrônio G.; LAUGENI, Fernando P. \textbf{Administração da produção}. São Paulo: Saraiva, 2006. \newline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Compreender os conceitos fundamentais de empreendedorismo, perfil e comportamento empreendedor nas organizações e na sociedade.
    \item Identificar e avaliar oportunidades de mercado e ideias de negócios com visão crítica, criativa e sustentável.
    \item Desenvolver modelos de negócios inovadores por meio de ferramentas visuais como o \textit{Business Model Canvas}.
    \item Aplicar metodologias ativas e o pensamento de design (\textit{Design Thinking}) na resolução de problemas organizacionais e sociais.
    \item Compreender a responsabilidade socioambiental, a ética, a diversidade cultural e os direitos humanos na atividade empresarial.
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
...
Criatividade, inovação e pensamento de design (\textit{Design Thinking}). \newline
Modelagem de Negócios: \textit{Business Model Canvas} (Proposta de Valor, Segmentos de Clientes, Canais, Relacionamento, Fontes de Receita, Recursos Principais, Atividades-Chave, Parcerias Principais e Estrutura de Custos). \newline
Introdução à análise simples de viabilidade mercadológica, técnica e financeira. \newline
\textbf{Temáticas Transversais Obrigatórias:} Relações etnorraciais, história e cultura afro-brasileira e indígena na atividade econômica; Ética, Direitos Humanos e inclusão no trabalho; Sustentabilidade, meio ambiente e responsabilidade social corporativa; Prevenção às formas de violência, saúde e segurança do trabalho.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Componente curricular desenvolvido por meio de metodologias ativas, com ênfase na Aprendizagem Baseada em Projetos (PBL), oficinas práticas de ideação, dinâmicas de validação e prototipação de modelos de negócios (\textit{Business Model Canvas}), estudos de caso e apresentações de propostas em formato \textit{pitch}. As atividades práticas de criação e modelagem utilizam os laboratórios de informática do câmpus e o Laboratório de Inovação, Empreendedorismo e Desenvolvimento Sustentável (LINEDS). Articula-se diretamente com Introdução à Administração, Gestão de Marketing I e II, Organização e Processos, Responsabilidade Socioambiental e Sustentabilidade, e Oficina de Integração I. \newline\vspace{2pt}
\textbf{Avaliação:} Diagnóstica, contínua e formativa, acompanhando a evolução dos estudantes no desenvolvimento das propostas de empreendimentos. Instrumentos: elaboração e apresentação do \textit{Business Model Canvas}, apresentações orais em equipe (\textit{pitches}), relatórios de projetos de ideação, listas de exercícios práticos e autoavaliação.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{DORNELAS, José Carlos Assis. \textbf{Empreendedorismo}: transformando ideias em negócios. 8. ed. São Paulo: Empreende / Atlas, 2021. 320 p. \newline
OSTERWALDER, Alexander; PIGNEUR, Yves. \textbf{Business Model Generation}: inovação em modelos de negócios. Rio de Janeiro: Alta Books, 2011. 288 p. \newline
CHIAVENATO, Idalberto. \textbf{Empreendedorismo}: dando asas ao espírito empreendedor. 4. ed. São Paulo: Manole, 2012. 312 p.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{RIES, Eric. \textbf{A startup enxuta}: como os empreendedores atuais utilizam a inovação contínua para criar empresas extremamente bem-sucedidas. São Paulo: Levir, 2012. 272 p. \newline
BLANK, Steve; DORF, Bob. \textbf{Startups}: manual do fundador. Rio de Janeiro: Alta Books, 2014. 608 p. \newline
MARCONDES, Reynaldo Cavalheiro \textit{et al.} \textbf{Planejamento e gestão de pequenos negócios}. São Paulo: Cengage Learning, 2017. 240 p.} \\ \hline
\end{xltabular}
...
IPONTELO, Juliana F.; CRUZ, Lucineide A. M. \textbf{Gestão de pessoas}: manual de rotinas trabalhistas. 8. ed. rev. e ampl. Brasília, DF: Senac-DF, 2016. \newline
...
\begin{xltabular}{\linewidth}{|X|p{2.5cm}|p{2.5cm}|}
\hline
\multirow{3}{=}{\textcolor{ifscgreen}{\textbf{Unidade Curricular:}}\\[3pt]\textbf{\large Gestão Financeira}} & \multicolumn{2}{p{\dimexpr5cm+2\tabcolsep+\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Semestre:}} \textbf{6º}} \\ \cline{2-3}
 & \textcolor{ifscgreen}{\textbf{CH EaD*:}} & \textcolor{ifscgreen}{\textbf{CH Total*:}} \\ \cline{2-3}
 & \textbf{00 h} & \textbf{40 h} \\ \hline
\endfirsthead
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Objetivos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Compreender a função financeira nas organizações e a importância da gestão do capital de giro e dos fluxos de caixa.
    \item Interpretar e elaborar demonstrações financeiras básicas (DRE, Balanço Patrimonial e Fluxo de Caixa) para apoio à tomada de decisão.
    \item Dominar conceitos e técnicas de matemática financeira aplicada (juros simples e compostos, fluxo de caixa descontado, amortização).
    \item Avaliar a viabilidade de investimentos simples e fontes de financiamento para micro, pequenas e médias empresas.
    \item Desenvolver visão ética, sustentável e responsável sobre o uso dos recursos financeiros nas corporações e no âmbito pessoal.
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Conteúdos:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
...
\textbf{Temáticas Transversais Obrigatórias:} Ética e transparência financeira; Direitos Humanos na gestão das relações de trabalho e fornecedores; Educação financeira corporativa, pessoal e consumo sustentável.
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Componente curricular eminentemente prático e applied, conduzido por meio de aulas expositivas dialogadas, resolução de problemas e planilhamento em laboratórios de informática utilizando planilhas eletrônicas (Google Sheets / Microsoft Excel). Estudos de caso de análise financeira de pequenos negócios locais e simulação de fluxos de caixa. Articula-se com Matemática para Administração, Gestão de Operações e Qualidade, Empreendedorismo I e II, e Oficina de Integração II. \newline\vspace{2pt}
\textbf{Avaliação:} Formativa, contínua e prática. Instrumentos: relatórios de resolução de casos práticos no computador, planilhas de controle de fluxo de caixa, listas de exercícios e provas teórico-práticas em laboratório de informática.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Básica:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{GITMAN, Lawrence J. \textbf{Princípios de administração financeira}. 14. ed. São Paulo: Pearson Education do Brasil, 2018. 832 p. \newline
HOJI, Masakazu. \textbf{Administração financeira e orçamentária}: matemática financeira aplicada, estratégias financeiras, orçamento empresarial. 12. ed. São Paulo: Atlas, 2021. 576 p. \newline
ASSAF NETO, Alexandre. \textbf{Finanças corporativas e valor}. 8. ed. São Paulo: Atlas, 2018. 768 p.} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Bibliografia Complementar:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{LE MÈSURIER, Paul. \textbf{Matemática financeira simplificada para cursos técnicos e superiores}. São Paulo: Atlas, 2015. 240 p. \newline
CASAROTTO FILHO, Nelson; KOPITTKE, Bruno Hartmut. \textbf{Análise de investimentos}: matemática financeira, engenharia econômica, tomada de decisão, estratégia empresarial. 11. ed. São Paulo: Atlas, 2018. 512 p. \newline
CHIAVENATO, Idalberto. \textbf{Planejamento e controle financeiro}. 3. ed. São Paulo: Manole, 2014. 288 p.} \\ \hline
\end{xltabular}
