...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Introdução à língua espanhola: fonética e pronúncia
    \item Cumprimentos e apresentações
    \item Vocabulário básico: cores, números, família, dias da semana
    \item Estruturas gramaticais básicas: verbos no presente, pronomes pessoais, artigos definidos e indefinidos
    \item Interculturalidade: costumes e tradições em países de língua espanhola
    \item Comunicação em situações cotidianas: compras, restaurantes, transportes
    \item Temáticas transversais: cidadania e segurança no trânsito, práticas sustentáveis em relação ao meio ambiente, e respeito aos direitos humanos em diferentes culturas hispanofalantes
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Revisão de estruturas gramaticais básicas
    \item Tempos verbais no passado: pretérito perfeito e imperfeito
    \item Vocabulário ampliado: alimentos, roupas, lazer, clima
    \item Interculturalidade: celebrações, festividades e cultura popular nos países hispanofalantes
    \item Comunicação em situações intermediárias: descrevendo pessoas, lugares e eventos
    \item Introdução à escrita de textos breves: cartas e e-mails informais
    \item Temáticas transversais: História e Cultura Afro-Brasileira e Indígena em contextos hispanofalantes, alimentação saudável e educação alimentar, e reflexões integradas sobre os direitos humanos
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Introdução à Física: a origem da Física, as áreas da Física, grandezas físicas e unidades de medidas
    \item noções básicas de Cinemática
    \item Movimento Uniforme e Movimento Uniformemente Variado
    \item Dinâmica (introdução)
    \item Leis de Newton e suas aplicações
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Trabalho de uma força e Conservação da Energia Mecânica
    \item Impulso e Conservação da quantidade de movimento
    \item Gravitação Universal
    \item Hidrostática
    \item Termometria, Dilatação Térmica e Gás Ideal
    \item Leis da Termodinâmica e Máquinas Térmicas
    \item Reflexão da Luz e Refração da Luz
    \item Movimento Ondulatório
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Carga elétrica, Força Eletrostática, Campo Elétrico, Potencial Elétrico e Energia Potencial Elétrica
    \item Corrente elétrica, Tipos de Corrente Elétrica, Resistores e Circuitos Elétricos CC e CA
    \item Diagramas de circuitos — unifilar e multifilar (aplicações)
    \item Magnetismo e Indução Eletromagnética
    \item Ondas Eletromagnéticas
    \item Introdução à Física Moderna
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Equação exponencial
    \item Função exponencial (definição, propriedades, gráfico, aplicações) e sua inversa (função logarítmica)
    \item Logaritmos (definição e propriedades)
    \item Equação logarítmica
    \item Função logarítmica (propriedades, gráfico, aplicações)
    \item Círculo trigonométrico (coordenadas, ângulos, quadrantes, seno, cosseno, tangente, periodicidade, aplicações)
    \item Funções trigonométricas (seno, cosseno, tangente, secante, cossecante, cotangente, gráficos, aplicações)
    \item Identidades trigonométricas
    \item Área e perímetro de figuras planas (triângulos, quadriláteros, hexágono regular e círculo)
    \item Geometria espacial (área das superfícies/planificação e volume de prismas, pirâmides, cilindro, cone e esfera)
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Aulas expositivas dialogadas; aulas de exercícios; apresentação em linguagem verbal por escrito ou em diálogos na sala de aula; discussões em grupos; estudos dirigidos; leitura e interpretação por meio de datashow; pesquisas em laboratório de informática; seminários; trabalho em laboratório de informática e na biblioteca; trabalhos individuais e em grupos; uso de jogos e objetos de aprendizagem; experimentação no ensino de matemática; produção de vídeos de matemática por estudantes. \newline\vspace{2pt}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Matrizes (definição, tipos, operações, matriz inversa e aplicações)
    \item Determinante de ordens 1, 2 e 3 (solução por Sarrus, propriedades)
    \item Sistemas lineares (sistemas equivalentes e homogêneos, resolução por escalonamento, sistemas com variáveis livres)
    \item Geometria analítica (distância entre pontos, estudo das retas)
    \item Análise combinatória (princípio da contagem, fatorial, arranjos, permutações e combinações)
    \item Probabilidade (espaço amostral e evento, probabilidade, união de probabilidade, probabilidade condicional)
    \item Polinômios (função polinomial, valor numérico, polinômio nulo, operações com polinômios)
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Aulas expositivas dialogadas; aulas de exercícios; apresentação em linguagem verbal por escrito ou em diálogos na sala de aula; discussões em grupos; estudos dirigidos; leitura e interpretação por meio de datashow; pesquisas em laboratório de informática; seminários; trabalho em laboratório de informática e na biblioteca; trabalhos individuais e em grupos; uso de jogos e objetos de aprendizagem; experimentação no ensino de matemática; produção de vídeos de matemática por estudantes. \newline\vspace{2pt}
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item O que é o Mito? Passagem do Mito à Filosofia
    \item Conceitos de Filosofia: o que é Filosofia e para que serve
    \item Filosofia e as outras formas de conhecimento
    \item A Razão: regras e princípios
    \item As concepções de verdade — Dogmatismo e busca da verdade
    \item Períodos da História da Filosofia
    \item Filosofia Antiga
    \item A Filosofia grega e os pré-socráticos
    \item Os sofistas
    \item Sócrates e a busca pela verdade
    \item Platão e o mito da caverna
    \item O amor a partir de Platão
    \item As cavernas contemporâneas
    \item Aristóteles, ética e política
    \item O homem como animal social
    \item As virtudes e a moderação
    \item A prudência
    \item A coragem
    \item As escolas helenísticas
    \item O estoicismo e a arte de bem viver
    \item O epicurismo e o prazer
    \item O ceticismo e o conhecimento
    \item O cinismo e o cosmopolitismo
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
...
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
    \item Filosofia Medieval Cristã
    \item A relação entre fé e razão
    \item A Patrística de Santo Agostinho
    \item A Escolástica de São Tomás de Aquino
    \item A Filosofia Moderna
    \item A filosofia política em Maquiavel
    \item O pensamento ensaístico de Montaigne
    \item Locke, Rousseau e Hobbes: a filosofia política
    \item Filosofia moderna e contemporânea
    \item Kant, a ética do dever e o esclarecimento
    \item Schopenhauer, pessimismo, vontade e irracionalismo
    \item Nietzsche e a crise dos valores
    \item Niilismo e a crise da razão
    \item Existencialismo e liberdade
    \item A condição da mulher nos séculos XX e XXI
    \item Existencialismo, feminismo e liberdade
    \item Política, Estado e Poder na contemporaneidade
    \item Ética e meio ambiente
    \item O mundo do trabalho e a alienação
    \item Indústria Cultural e consumo
\end{itemize}
} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textcolor{ifscgreen}{\textbf{Estratégias de Ensino e Aprendizagem:}}} \\ \hline
\multicolumn{3}{|p{\dimexpr\linewidth-2\tabcolsep-2\arrayrulewidth\relax}|}{\textbf{Metodologia:} Aulas expositivas, leituras interpretativas e críticas, seminários e apresentações individuais e/ou em grupo, pesquisa bibliográfica e produção de textos. \newline\vspace{2pt}
