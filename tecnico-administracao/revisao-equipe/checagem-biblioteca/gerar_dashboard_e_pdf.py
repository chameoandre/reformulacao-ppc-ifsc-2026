...
<head>
  ...
  <style>
    :root {{
      /* TEMA CLARO INSTITUCIONAL (PADRÃO) */
      --ifsc-green: #059669;
    ...
    [data-theme="dark"] {{
      ...
      --header-bg: linear-gradient(135deg, #064e3b 0%, #090d16 100%);
    }}
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    [data-theme="dark"] table.custom-table th {{
      background: #131b2e;
      color: #94a3b8;
    }}
    ...
    .badge-sim {{ background: #ECFDF5; color: #047857; border: 1px solid #A7F3D0; }}
    .badge-nao {{ background: #FFF1F2; color: #BE123C; border: 1px solid #FECDD3; }}
    .badge-var {{ background: #FFFBEB; color: #B45309; border: 1px solid #FDE68A; }}
    .badge-fnde {{ background: #F0F9FF; color: #0369A1; border: 1px solid #BAE6FD; }}
    .badge-autor {{ background: #F5F3FF; color: #6D28D9; border: 1px solid #DDD6FE; }}

    .badge-basica {{ background: #F0F9FF; color: #0369A1; border: 1px solid #BAE6FD; }}
    .badge-comp {{ background: #F8FAFC; color: #475569; border: 1px solid #E2E8F0; }}
    .badge-ppc-tag {{ background: #ECFDF5; color: #047857; border: 1px solid #A7F3D0; font-weight: 800; }}
    ...
    .uc-card:hover {{ border-color: #CBD5E1; box-shadow: var(--card-shadow-hover); }}
    .uc-card-header {{
      padding: 1rem 1.3rem;
      cursor: pointer;
      display: flex;
...
<body>
  ...
  <header class="app-header">
    <div class="header-container">
      ...
      <div class="header-actions">
        ...
        <a href="https://docs.google.com/document/d/1gWQex1_-ILrsSecV-DlObKisM_iBON-i/edit?usp=sharing&ouid=103449863491083063065&rtpof=true&sd=true" target="_blank" class="btn-action btn-blue">
  ...
  <main class="main-container">
    ...
    <div class="kpi-grid">
      <div class="kpi-card kpi-rose" onclick="scrollToSection('secao-compras-basica')" title="Clique para ver a lista de compras da Básica">
        ...
        <div class="kpi-desc">Exemplares a adquirir para atingir a meta de 3 cópias por título básico (Clique para ver)</div>
      </div>
      ...
      <div style="background:var(--bg-card); border:1px solid var(--border-color); border-radius:var(--radius-lg); padding:2rem; margin-bottom:1.5rem;">
        ...
        <div style="border-bottom:2px solid var(--border-color); padding-bottom:1.5rem; margin-bottom:1.5rem; display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:1rem;">
          ...
          <div style="display:flex; gap:0.6rem; flex-wrap:wrap;">
            ...
            <a href="relatorio_auditoria_biblioteca.pdf" target="_blank" class="btn-action btn-outline">
              <i class="bi bi-file-earmark-pdf-fill" style="color:#fb7185;"></i> Relatório LaTeX
            </a>
          </div>
        </div>
        ...
        <div style="margin-bottom:1.8rem;">
          ...
          <div style="background:rgba(15,23,42,0.6); border:1px solid var(--border-color); border-radius:10px; padding:1rem; font-size:0.88rem; line-height:1.7;">
            ...
            <ul style="margin-top:0.5rem; padding-left:1.2rem; color:#f1f5f9;">
              <li style="margin-bottom:0.4rem;">
                <strong>Bibliografia Básica:</strong> Mínimo de <strong>2 títulos de livros</strong> por Unidade Curricular, devendo o acervo do câmpus disponibilizar <strong>ao menos 3 exemplares físicos de cada título</strong> (ou livro PNLD com 1 exemplar por estudante).
                <a href="#secao-compras-basica" onclick="scrollToSection('secao-compras-basica'); return false;" style="color:#fb7185; margin-left:8px; font-weight:700; text-decoration:underline;">&rarr; Ver relação de obras a adquirir (+{total_deficit_basica} ex.)</a>
              </li>
              <li>
                <strong>Bibliografia Complementar:</strong> Mínimo de <strong>3 títulos de livros</strong> por Unidade Curricular, devendo o acervo do câmpus disponibilizar <strong>ao menos 1 exemplar físico de cada título</strong>.
                <a href="#secao-compras-comp" onclick="scrollToSection('secao-compras-comp'); return false;" style="color:#fbbf24; margin-left:8px; font-weight:700; text-decoration:underline;">&rarr; Ver relação de obras a adquirir (+{total_deficit_comp} ex.)</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="table-container" style="margin-bottom:1rem;">
            <table class="custom-table">
              ...
              <tbody>
                ...
                <tr style="background:rgba(244,63,94,0.12); cursor:pointer; transition:all 0.2s;" onclick="scrollToSection('secao-compras-basica')" onmouseover="this.style.background='rgba(244,63,94,0.22)'" onmouseout="this.style.background='rgba(244,63,94,0.12)'" title="Clique para ir direto à lista de compras da Bibliografia Básica">
                  <td>
                    <a href="#secao-compras-basica" onclick="scrollToSection('secao-compras-basica'); return false;" style="color:#fb7185; text-decoration:underline; font-weight:800; font-size:0.92rem; display:inline-flex; align-items:center; gap:0.4rem;">
                      <i class="bi bi-box-arrow-in-down-right"></i> DEMANDA DE COMPRAS: Bibliografia BÁSICA
                    </a>
                  </td>
                  <td>
                    <a href="#secao-compras-basica" onclick="scrollToSection('secao-compras-basica'); return false;" style="color:#fb7185; text-decoration:none; font-weight:800; font-size:1.05rem;">
                      +{total_deficit_basica} exemplares físicos
                    </a>
                  </td>
                  <td>
                    <a href="#secao-compras-basica" onclick="scrollToSection('secao-compras-basica'); return false;" style="color:var(--text-main); text-decoration:none; display:inline-flex; align-items:center; gap:0.5rem;">
                      Meta: &ge; 3 exemplares por título básico <span class="badge badge-nao"><i class="bi bi-arrow-down-circle-fill"></i> Ver Lista Completa</span>
                    </a>
                  </td>
                </tr>
                <tr style="background:rgba(245,158,11,0.12); cursor:pointer; transition:all 0.2s;" onclick="scrollToSection('secao-compras-comp')" onmouseover="this.style.background='rgba(245,158,11,0.22)'" onmouseout="this.style.background='rgba(245,158,11,0.12)'" title="Clique para ir direto à lista de compras da Bibliografia Complementar">
                  <td>
                    <a href="#secao-compras-comp" onclick="scrollToSection('secao-compras-comp'); return false;" style="color:#fbbf24; text-decoration:underline; font-weight:800; font-size:0.92rem; display:inline-flex; align-items:center; gap:0.4rem;">
                      <i class="bi bi-box-arrow-in-down-right"></i> DEMANDA DE COMPRAS: Bibliografia COMPLEMENTAR
                    </a>
                  </td>
                  <td>
                    <a href="#secao-compras-comp" onclick="scrollToSection('secao-compras-comp'); return false;" style="color:#fbbf24; text-decoration:none; font-weight:800; font-size:1.05rem;">
                      +{total_deficit_comp} exemplares físicos
                    </a>
                  </td>
                  <td>
                    <a href="#secao-compras-comp" onclick="scrollToSection('secao-compras-comp'); return false;" style="color:var(--text-main); text-decoration:none; display:inline-flex; align-items:center; gap:0.5rem;">
                      Meta: &ge; 1 exemplar por título complementar <span class="badge badge-var"><i class="bi bi-arrow-down-circle-fill"></i> Ver Lista Completa</span>
                    </a>
                  </td>
                </tr>
  ...
  <script>
    ...
    function scrollToSection(sectionId) {{
      switchTab('tab-sumario', false);
      setTimeout(() => {{
        const el = document.getElementById(sectionId);
        if (el) {{
          el.scrollIntoView({{ behavior: 'smooth', block: 'start' }});
          el.style.boxShadow = '0 0 0 3px var(--accent-emerald)';
    ...
    function toggleTheme() {{
      ...
      localStorage.setItem('dashboard_theme_adm', newTheme);
    ...
    // Initial render & theme init
    document.addEventListener('DOMContentLoaded', () => {{
      const saved = localStorage.getItem('dashboard_theme_adm') || 'light';
